 ...
 //                 async: false, (Well, maybe....)
    ...
    $('#addNew').click(function () {
        ...
        if ($(".date" + momentDate)[0]) { //If there is a date already
            if ($(ifStatement)[0]) {
                $(".date" + momentDate).next(ifStatement).last().after("<li class='meta " + newSubject + "' style='background:" + colours[random] + "'><p class='deleteButton'>×</p><span class='related'>Related Stories:<br/></span><span class='entry contenteditable' contenteditable='true'>" + newPublication + " - " + newTitle + "<br/></span>" + newURL + "<a class='toggle'> &bull; toggle</a><br /></li>");
            } else {
                $('.date' + momentDate).after("<li class='meta " + newSubject + "' style='background:" + colours[random] + "'><p class='deleteButton'>×</p><span class='sectiontitle contenteditable' contenteditable='true'>" + newSubjectText + "<br/></span><span class='related hidden'>Related Stories:<br/></span><span class='entry contenteditable' contenteditable='true'>" + newPublication + " - " + newTitle + "<br/></span>" + newURL + "<a class='toggle'> &bull; toggle</a><br /><br /><ul class='context'><li class='contenteditable quote' contenteditable='true'>" + newContext + "<br/></li><br/></ul></li>");
            }
