    ...
    $('#addNew').click(function () {
        ...
        if ($(".date" + momentDate)[0]) { //If there is this date already
            if ($(ifStatement)[0]) { //This is a related
                $(ifStatement).append("<li class='meta-li " + newSubject + " isrelated related' style='background:" + colours[random] + "'><p class='deleteButton'>&#x2716;</p><span class='entry contenteditable' contenteditable='true'>" + newPublication + " - " + newTitle + "<br/></span>" + newURL + "&nbsp;<a class='article-link' href='" + newURL + "'>(link)</a><br /></li>");
            } else {
                $('.date' + momentDate).after("<div class='meta " + newSubject + "' style='background:" + colours[random] + "'><p class='deleteButton'>&#x2716;</p><span class='sectiontitle contenteditable' contenteditable='true'>" + newSubjectText + "<br/></span><span class='entry contenteditable' contenteditable='true'>" + newPublication + " - " + newTitle + "<br/></span>" + newURL + "&nbsp;<a class='article-link' href='" + newURL + "'>(link)</a><br /><br /><ul class='context'><li class='contenteditable quote' contenteditable='true'>" + newContext + "<br/></li><br/></ul></div>");
